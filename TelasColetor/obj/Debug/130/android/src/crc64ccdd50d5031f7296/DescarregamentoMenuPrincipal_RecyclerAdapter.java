...
public class DescarregamentoMenuPrincipal_RecyclerAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TelasColetor.Fonte.Descarregamento.DescarregamentoMenuPrincipal+RecyclerAdapter, TelasColetor", DescarregamentoMenuPrincipal_RecyclerAdapter.class, __md_methods);
	}


	public DescarregamentoMenuPrincipal_RecyclerAdapter ()
	{
		super ();
		if (getClass () == DescarregamentoMenuPrincipal_RecyclerAdapter.class) {
			mono.android.TypeManager.Activate ("TelasColetor.Fonte.Descarregamento.DescarregamentoMenuPrincipal+RecyclerAdapter, TelasColetor", "", this, new java.lang.Object[] {  });
		}
	}
