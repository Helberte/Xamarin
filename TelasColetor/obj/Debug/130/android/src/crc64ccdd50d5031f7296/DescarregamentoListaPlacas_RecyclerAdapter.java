...
public class DescarregamentoListaPlacas_RecyclerAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TelasColetor.Fonte.Descarregamento.DescarregamentoListaPlacas+RecyclerAdapter, TelasColetor", DescarregamentoListaPlacas_RecyclerAdapter.class, __md_methods);
	}


	public DescarregamentoListaPlacas_RecyclerAdapter ()
	{
		super ();
		if (getClass () == DescarregamentoListaPlacas_RecyclerAdapter.class) {
			mono.android.TypeManager.Activate ("TelasColetor.Fonte.Descarregamento.DescarregamentoListaPlacas+RecyclerAdapter, TelasColetor", "", this, new java.lang.Object[] {  });
		}
	}
