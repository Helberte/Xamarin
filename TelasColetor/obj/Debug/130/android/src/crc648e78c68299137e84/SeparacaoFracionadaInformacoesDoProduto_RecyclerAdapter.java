...
public class SeparacaoFracionadaInformacoesDoProduto_RecyclerAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TelasColetor.Fonte.SeparacaoFracionada.SeparacaoFracionadaInformacoesDoProduto+RecyclerAdapter, TelasColetor", SeparacaoFracionadaInformacoesDoProduto_RecyclerAdapter.class, __md_methods);
	}


	public SeparacaoFracionadaInformacoesDoProduto_RecyclerAdapter ()
	{
		super ();
		if (getClass () == SeparacaoFracionadaInformacoesDoProduto_RecyclerAdapter.class) {
			mono.android.TypeManager.Activate ("TelasColetor.Fonte.SeparacaoFracionada.SeparacaoFracionadaInformacoesDoProduto+RecyclerAdapter, TelasColetor", "", this, new java.lang.Object[] {  });
		}
	}
