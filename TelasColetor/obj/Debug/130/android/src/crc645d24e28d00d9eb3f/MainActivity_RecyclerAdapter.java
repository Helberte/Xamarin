...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TelasColetor.MainActivity+RecyclerAdapter, TelasColetor", MainActivity_RecyclerAdapter.class, __md_methods);
	}


	public MainActivity_RecyclerAdapter ()
	{
		super ();
		if (getClass () == MainActivity_RecyclerAdapter.class) {
			mono.android.TypeManager.Activate ("TelasColetor.MainActivity+RecyclerAdapter, TelasColetor", "", this, new java.lang.Object[] {  });
		}
	}
