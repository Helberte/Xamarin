...
public class SepararPaleteProdutosDoDocumento_RecyclerAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TelasColetor.Fonte.SepararPaleteProdutosDoDocumento+RecyclerAdapter, TelasColetor", SepararPaleteProdutosDoDocumento_RecyclerAdapter.class, __md_methods);
	}


	public SepararPaleteProdutosDoDocumento_RecyclerAdapter ()
	{
		super ();
		if (getClass () == SepararPaleteProdutosDoDocumento_RecyclerAdapter.class) {
			mono.android.TypeManager.Activate ("TelasColetor.Fonte.SepararPaleteProdutosDoDocumento+RecyclerAdapter, TelasColetor", "", this, new java.lang.Object[] {  });
		}
	}
