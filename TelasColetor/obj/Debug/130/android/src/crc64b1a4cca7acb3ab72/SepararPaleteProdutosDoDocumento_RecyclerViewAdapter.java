...
public class SepararPaleteProdutosDoDocumento_RecyclerViewAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TelasColetor.Fonte.SepararPaleteProdutosDoDocumento+RecyclerViewAdapter, TelasColetor", SepararPaleteProdutosDoDocumento_RecyclerViewAdapter.class, __md_methods);
	}


	public SepararPaleteProdutosDoDocumento_RecyclerViewAdapter ()
	{
		super ();
		if (getClass () == SepararPaleteProdutosDoDocumento_RecyclerViewAdapter.class) {
			mono.android.TypeManager.Activate ("TelasColetor.Fonte.SepararPaleteProdutosDoDocumento+RecyclerViewAdapter, TelasColetor", "", this, new java.lang.Object[] {  });
		}
	}
