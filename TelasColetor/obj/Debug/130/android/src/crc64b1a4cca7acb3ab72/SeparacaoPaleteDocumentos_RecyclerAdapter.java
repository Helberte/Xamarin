...
public class SeparacaoPaleteDocumentos_RecyclerAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TelasColetor.Fonte.SeparacaoPaleteDocumentos+RecyclerAdapter, TelasColetor", SeparacaoPaleteDocumentos_RecyclerAdapter.class, __md_methods);
	}


	public SeparacaoPaleteDocumentos_RecyclerAdapter ()
	{
		super ();
		if (getClass () == SeparacaoPaleteDocumentos_RecyclerAdapter.class) {
			mono.android.TypeManager.Activate ("TelasColetor.Fonte.SeparacaoPaleteDocumentos+RecyclerAdapter, TelasColetor", "", this, new java.lang.Object[] {  });
		}
	}
