...
public class SepararPaleteListaDeBaias_RecyclerAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TelasColetor.Fonte.SepararPaleteListaDeBaias+RecyclerAdapter, TelasColetor", SepararPaleteListaDeBaias_RecyclerAdapter.class, __md_methods);
	}


	public SepararPaleteListaDeBaias_RecyclerAdapter ()
	{
		super ();
		if (getClass () == SepararPaleteListaDeBaias_RecyclerAdapter.class) {
			mono.android.TypeManager.Activate ("TelasColetor.Fonte.SepararPaleteListaDeBaias+RecyclerAdapter, TelasColetor", "", this, new java.lang.Object[] {  });
		}
	}
