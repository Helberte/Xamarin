...
public class SeparacaoPaletizada_RecyclerAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TelasColetor.Fonte.SeparacaoPaletizada+RecyclerAdapter, TelasColetor", SeparacaoPaletizada_RecyclerAdapter.class, __md_methods);
	}


	public SeparacaoPaletizada_RecyclerAdapter ()
	{
		super ();
		if (getClass () == SeparacaoPaletizada_RecyclerAdapter.class) {
			mono.android.TypeManager.Activate ("TelasColetor.Fonte.SeparacaoPaletizada+RecyclerAdapter, TelasColetor", "", this, new java.lang.Object[] {  });
		}
	}
